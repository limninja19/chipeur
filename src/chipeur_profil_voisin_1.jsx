    ...
    <div style={{ background: C.card, flexShrink: 0, borderBottom: `1px solid ${C.border}` }}>
      <div style={{ padding: "12px 16px 8px", display: "flex", alignItems: "flex-start", gap: 12 }}>
        <div style={{ position: "relative", flexShrink: 0 }}>
          ...
          <div style={{ position: "absolute", bottom: -6, left: "50%", transform: "translateX(-50%)", background: "linear-gradient(135deg,#FF5733,#F7A72D)", color: "#fff", fontSize: 8, fontWeight: 800, padding: "2px 7px", borderRadius: 8, whiteSpace: "nowrap", border: `2px solid ${C.card}` }}>✦ Pépite du Quartier</div>
        </div>
