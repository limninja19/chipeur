      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
          <div style={{ background: s.bgPill, borderRadius: 20, padding: "4px 12px", display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontFamily: syne, fontWeight: 500, fontSize: 11, color: s.color }}>{s.label}</span>
          </div>
        </div>

        <div style={{ fontFamily: syne, fontWeight: 500, fontSize: 14, color: "#1A1714", marginBottom: 4 }}>{s.title}</div>
