...
const defisData = [
  {
    id: 0, icon: "👟", title: "Défi Sneakers",
    sub: "Montre ta paire la plus stylée du quartier",
    participants: 47, objectif: 100, pct: 47,
    grad: "linear-gradient(135deg,#FF5733,#F7A72D)", fill: "#FF5733",
    timeLeft: "3 jours restants",
    tags: ["#Sneakers", "#Vintage", "#Streetwear", "#Local", "#Seconde main"],
    ended: false,
  },
  {
    id: 1, icon: "🧥", title: "Vintage Revival",
    sub: "Ta meilleure pièce chinée cette semaine",
    participants: 28, objectif: 80, pct: 35,
    grad: "linear-gradient(135deg,#5B2D8E,#9B59B6)", fill: "#7B4FBA",
    timeLeft: "5 jours restants",
    tags: ["#Vintage", "#Chiné", "#Seconde main", "#Mode", "#Pépite"],
    ended: false,
  },
  {
    id: 2, icon: "🌿", title: "Look Éco-Responsable",
    sub: "Mode durable, style local",
    participants: 102, objectif: 100, pct: 100,
    grad: "linear-gradient(135deg,#0A3D2E,#1D9E75)", fill: "#1D9E75",
    timeLeft: "Terminé · 102 posts",
    tags: ["#Éco", "#Durable", "#Local", "#Upcycling"],
    ended: true,
  },
  {
    id: 3, icon: "🎒", title: "Rentrée Style",
    sub: "Ton look sac + tenue du jour",
    participants: 12, objectif: 60, pct: 20,
    grad: "linear-gradient(135deg,#185FA5,#378ADD)", fill: "#378ADD",
    timeLeft: "8 jours restants",
    tags: ["#Rentrée", "#OOTD", "#Sac", "#Tenue"],
    ended: false,
  },
];
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "center" }}>
          {[
            ...
            { n: d.ended ? "—" : d.timeLeft.split(" ")[0], l: d.ended ? "terminé" : "restants" },
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "16px 18px 100px" }}>
        <div style={{ background: C.card, borderRadius: 16, padding: 14, marginBottom: 14, border: `1px solid ${C.border}` }}>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, color: C.ink2, marginBottom: 8 }}>
            ...
            <strong style={{ color: C.ink }}>{d.pct}%</strong>
          </div>
          <div style={{ height: 8, background: C.pill, borderRadius: 4, overflow: "hidden" }}>
            <div style={{ height: "100%", borderRadius: 4, width: `${Math.min(d.pct, 100)}%`, background: d.grad }} />
          </div>
        </div>
        ...
        {recentPosts.map((p, i) => (
          <div key={i} style={{
            ...
            <div style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: 22, flexShrink: 0, background: p.bg,
            }}>{p.avatar}</div>
      ...
      {!d.ended && (
        <button
          ...
          style={{
            ...
            color: "#fff", background: d.fill, zIndex: 10,
          }}
    ...
    <div style={{ display: "flex", flexDirection: "column", flex: 1, overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "16px 20px 100px" }}>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <textarea
            placeholder="Décris ta pièce, où tu l'as trouvée…"
            rows={3}
            style={{
      ...
      <button
        ...
        style={{
          position: "absolute", bottom: 90, left: 20, right: 20,
          background: imgPreview ? C.accent : "#ccc",
          color: "#fff", border: "none", borderRadius: 18, padding: 16,
          fontSize: 15, fontWeight: 700, fontFamily: dm,
          cursor: imgPreview ? "pointer" : "not-allowed", zIndex: 10,
        }}
      >Publier mon post 🔥</button>
    </div>
  );
}
        ...
        <>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 18, padding: 14, fontSize: 14, fontWeight: 700,
              fontFamily: dm, cursor: "pointer", zIndex: 5,
            }}
